...
angular.module('insight.blocks').controller('BlocksController',
    function($scope, $rootScope, $routeParams, $location, Global, Block, Blocks, BlockByHeight) {
        ...
        $scope.isSegwit = function(version) {
            /*if (version < 0) {
                version = 0xFFFFFFFF + version + 1;
            }
            version.toString(16).toUpperCase();*/
            if (version === '20007002' || version === '20007202' || version === '20007402' || version === '20007602' || version === '20007802') return true;
            return false;
        };
